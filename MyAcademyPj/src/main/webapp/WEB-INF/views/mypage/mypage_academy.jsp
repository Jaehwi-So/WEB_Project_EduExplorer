	...
	<main>
		...
		<div id="my_content">
			<div class="content_img">
					<img src="${pageContext.request.contextPath}/resources/img/mypage_academy.png" style="display:inline;" width="80px" height="80px">
				</div>
				<div class="content_title">
					<h1>내가 등록한 학원</h1>
					<p>내가 학원찾기 게시판에 홍보 목적으로 올린 게시물 목록을 가져옵니다</p>
				</div>
			...
			<div class="content">
				<table border="1" >
					...
					<c:if test="${ !empty myacademy_list }">
						<c:forEach var="vo" items="${myacademy_list}">
					...
					<c:if test="${ empty myacademy_list}">
						<tr>
							<td colspan="5">내가 등록한 학원이 없습니다</td>
						</tr>
					</c:if>
				</table>
				</td>
