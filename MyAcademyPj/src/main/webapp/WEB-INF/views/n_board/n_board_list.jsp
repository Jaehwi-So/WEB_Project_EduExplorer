...
<script>
	function go_detail(del_info, n_idx){
		if(del_info != -1){
			location.href="n_view.com?n_idx="+n_idx+"&page=${ empty param.page ? 1 : param.page}";
		}
	}
</script>
</head>
<body>
	<main>
		...
		<hr>
		<br>
		<table width="1000" align="center" id="n_table_a">
			<tr>
				<td>
					<table width="1000" align="center" id="n_table_b">
									...
									<c:forEach var="vo" items="${n_list}">
										<tr class="n_tr_list" onclick="go_detail(${vo.del_info}, ${vo.n_idx })">
											...
											<td align="center" class="td_b_1 left">
												<!-- 댓글 들여쓰기 --> <%-- <c:forEach begin="1" end="${vo.depth}">
										&nbsp;
										</c:forEach> <c:if test="${vo.depth ne 0}">
										└ </c:if>--%> <!-- del_info가 -1이 아닌 경우 --> 
						...
						<tr>
							<td>
								<table width="1000" bgcolor="#f5f2c4">
									<tr>
										<td class="f11" align="center">${n_pagemenu}</td>
									</tr>
								</table>
							</td>
						</tr>
						...
						<tr>
							<td><img
								...
								onclick="location.href='n_insert_form.com'"
