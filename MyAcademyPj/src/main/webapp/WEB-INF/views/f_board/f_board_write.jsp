...
<html>
	...
	<body>
		<main>
			...
			<hr>
			<br>
			<form name="f" method="post" action="f_insert.do">
				...
				<table width="750">
					...
					<tr>
						...
						<img class="util_btn" src="${pageContext.request.contextPath}/resources/img/btn_reg.gif" onclick="send_check();"> 
						<img class="util_btn" src="${pageContext.request.contextPath}/resources/img/btn_back.gif" onclick="location.href='f_list.do'"></td>
					</tr>
				</table>
			</form>
		</main>
