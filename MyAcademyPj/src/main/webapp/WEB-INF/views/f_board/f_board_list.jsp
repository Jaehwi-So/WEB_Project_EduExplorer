		...
		<style>
			...
			#f_banner{ 
			 ...
			 #f_banner .f_banner_content{
			       	width: 650px; height: 40px; margin: 5px; float : right;
			 }
...
<body>
	<main>
		...
		<hr>
		<br>
		<table width="1000" align="center" id="f_table_a">
			<tr>
				<td>
					<!-- <table width="690">  -->
					<table width="1000" align="center" id="f_table_b"> 
						<!-- tr1 -->
						<tr>
							<td>
								<table width="1000" align="center" id="f_table_c">
									<tr class="f_td_tr">
										<th width="50" class="td_a" align="center">번호
										</th>
										<td width="2" class="td_b"></td>
										<th width="300" class="td_b" align="center">제목
										</th>
										<td width="2" class="td_b"></td>
										<th width="90" class="td_b" align="center">작성자
										</th>
										<td width="2" class="td_b"></td>
										<th width="90" class="td_b" align="center">작성일
										</th>
										<td width="2" class="td_b"></td>
										<th width="60" class="td_c" align="center">조회수
										</th>
									</tr>
									<c:forEach var="vo" items="${f_list}">
										<tr class="f_tr_list" onclick="go_detail(${vo.del_info}, ${vo.f_idx });">
									...
									<c:if test="${empty f_list }">
										<tr>
											<td align="center" colspan="11" height="50"><b>현재
													등록된 게시글이 없습니다</b></td>
						...
						<tr>
							<td>
								<table width="1000" bgcolor="#f5f2c4">
									<tr>
		...
		<form>
			<div id="f_search">
				...
				<input
					class="f_button" type="button" value="검색하기" onclick="keyword_search(this.form);">
				 
				<!-- 
				<img
					src="${pageContext.request.contextPath}/resources/img/btn_search.gif"
					onclick="keyword_search(this.form);"
