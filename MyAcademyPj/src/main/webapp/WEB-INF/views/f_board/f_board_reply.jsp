...
<body>
	<form name="f" method="post" action="f_reply.com">
		...
		<table width="750">
			...
			<tr>
				<td align="center" height="10"><img src="${pageContext.request.contextPath}/resources/img/btn_reg.gif" onclick="send_check();">
				<img src="${pageContext.request.contextPath}/resources/img/btn_back.gif" onclick="location.href='f_list.com'">
				</td>
			</tr>
		</table>
	</form>
